...
public class BQValidation {
  ...
  /**
   * Compares the data in the result set obtained from the MySQL database with the provided BigQuery JSON objects.
   *
   * @param rsSource     The result set obtained from the MySQL database.
